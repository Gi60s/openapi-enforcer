...
describe('Paths - Auto Generated Tests', () => {
  describe('v2', () => {
    ...
    describe('spec version support', () => {
      it('supports version 2.0', () => {
        ...
        const es = Paths.validate(def, '2.0')
      ...
      it('does not support version X.Y.Z', () => {
        const def = Paths.createDefinition()
        // @ts-expect-error
        const es = Paths.validate(def, 'X.Y.Z')
