...
export interface II18nMessagesMap {
  ...
  SCHEMA_ALL_ADDITIONAL_PROPERTIES_CONFLICT: IMessage
  SCHEMA_ALL_DEFAULTS_CONFLICT: IMessage
  SCHEMA_ALL_DISCRIMINATORS_CONFLICT: IMessage
  SCHEMA_ALL_DISCRIMINATOR_MAPPINGS_CONFLICT: IMessage
  SCHEMA_ALL_ENUMS_CONFLICT: IMessage
  SCHEMA_ALL_EXAMPLES_CONFLICT: IMessage
  SCHEMA_ALL_FORMATS_CONFLICT: IMessage
  SCHEMA_ALL_NULLABLES_CONFLICT: IMessage
  SCHEMA_ALL_PATTERNS_CONFLICT: IMessage
  SCHEMA_ALL_TYPES_CONFLICT: IMessage
  ...
  SCHEMA_TYPE_FORMAT_DATE_TIME_LENGTH: IMessage
  SCHEMA_TYPE_INDETERMINATE: IMessage
  SCHEMA_TYPE_INVALID: IMessage
  SCHEMA_TYPE_INVALID_FILE: IMessage
