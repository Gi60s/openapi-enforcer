...
export interface II18nMessagesMap {
  ...
  SCHEMA_ALL_ADDITIONAL_PROPERTIES_CONFLICT: string
  SCHEMA_ALL_DEFAULTS_CONFLICT: string
  SCHEMA_ALL_DISCRIMINATORS_CONFLICT: string
  SCHEMA_ALL_DISCRIMINATOR_MAPPINGS_CONFLICT: string
  SCHEMA_ALL_ENUMS_CONFLICT: string
  SCHEMA_ALL_EXAMPLES_CONFLICT: string
  SCHEMA_ALL_FORMATS_CONFLICT: string
  SCHEMA_ALL_NULLABLES_CONFLICT: string
  SCHEMA_ALL_PATTERNS_CONFLICT: string
  SCHEMA_ALL_TYPES_CONFLICT: string
