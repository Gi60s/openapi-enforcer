...
export { Definition as HeaderDefinition } from './components/Header'
...
export { Definition as SchemaDefinition } from './components/Schema'
...
export { Dereference, Reference } from './components/Reference'
