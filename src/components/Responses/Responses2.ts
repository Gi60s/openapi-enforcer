...
export class Responses extends EnforcerComponent<I.IResponses2Definition> implements I.IResponses2 {
  ...
  static async createAsync (definition?: Partial<I.IResponses2Definition> | Responses | string | undefined): Promise<Responses> {
    if (definition instanceof Responses) {
      return await this.createAsync(Object.assign({}, definition))
    } else {
      if (definition !== undefined) definition = await Loader.loadAsyncAndThrow(definition)
      return this.create(definition as Partial<I.IResponses2Definition>)
    }
  }

  static createDefinition<T extends Partial<I.IResponses2Definition>> (definition?: T | undefined): I.IResponses2Definition & T {
    return Object.assign({}, definition) as I.IResponses2Definition & T
  }
  ...
  static async validateAsync (definition: I.IResponses2Definition | string, version?: IVersion): Promise<ExceptionStore> {
