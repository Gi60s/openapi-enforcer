...
export class Schema extends EnforcerComponent implements ISchema2 {
  ...
  static getSchema (data: ISchemaProcessor): ISchema.IDefinition<ISchema2Definition, ISchema2> {
    ...
    const allOf: ISchema.IProperty<ISchema.IComponent<ISchema2Definition, ISchema2>> = {
      name: 'allOf',
      schema: {
        type: 'component',
        allowsRef: true,
    ...
    const properties: ISchema.IProperty<ISchema.IComponent<ISchema2Definition, ISchema2>> = {
      name: 'properties',
      schema: {
        type: 'component',
        allowsRef: true,
