...
import { SecurityScheme2, ISecurityScheme2 } from '../SecurityScheme'
import { SecurityRequirement2, ISecurityRequirement2 } from '../SecurityRequirement'
import { Tag2, ITag2 } from '../Tag'
