...
export const versions = Object.freeze({
  '3.0.0': 'http://spec.openapis.org/oas/v3.0.0#encoding-object',
  '3.0.1': 'http://spec.openapis.org/oas/v3.0.1#encoding-object',
  '3.0.2': 'http://spec.openapis.org/oas/v3.0.2#encoding-object',
  '3.0.3': 'http://spec.openapis.org/oas/v3.0.3#encoding-object'
})

export const Component = class Encoding extends EnforcerComponent<Definition, Object> implements Object {
  readonly allowReserved?: boolean
  readonly contentType?: string
  readonly explode?: boolean
  readonly headers?: { [key: string]: Header.Object }
